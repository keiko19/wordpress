...
ArticalPage.prototype = {
    TPL : ['<div class="back js-backHome pointer"><div class="wrap"><span class="btn"></span><span class="btn-txt">BACK</span></div></div>',
           '<div class="main">',
            ...
            '{{if next_url}}<a class="prev-artical pointer" title="上一篇文章" href="{{next_url}}"></a><a href="{{next_url}}" class="prev-txt">PREV</a>{{/if}}',
            '<a class="home_phone icon iconfont js-backHome pointer">&#xe608;</a>',
            '{{if previous_url}}<a class="next-txt" href="{{previous_url}}">NEXT</a><a class="next-artical pointer" title="下一篇文章" href="{{previous_url}}"></a>{{/if}}',
            '</div>',
            '</div>',
            '<div class="comments">',
